...
${OBJECTDIR}/fastlogger/fastlogger.o: fastlogger/fastlogger.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fastlogger/fastlogger.o fastlogger/fastlogger.c
...
${OBJECTDIR}/gestionlog.o: gestionlog.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gestionlog.o gestionlog.c
...
${OBJECTDIR}/fastlogger/fastlogger_nomain.o: ${OBJECTDIR}/fastlogger/fastlogger.o fastlogger/fastlogger.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fastlogger/fastlogger_nomain.o fastlogger/fastlogger.c;\
	else  \
...
${OBJECTDIR}/gestionlog_nomain.o: ${OBJECTDIR}/gestionlog.o gestionlog.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gestionlog_nomain.o gestionlog.c;\
	else  \
