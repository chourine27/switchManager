...
${TESTDIR}/tests/Test_gestioncommandes.o: tests/Test_gestioncommandes.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -DVOCORE -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Test_gestioncommandes.o tests/Test_gestioncommandes.c


${TESTDIR}/tests/Test_gestionfichier.o: tests/Test_gestionfichier.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -DVOCORE -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Test_gestionfichier.o tests/Test_gestionfichier.c
...
${OBJECTDIR}/gestioncommandes_nomain.o: ${OBJECTDIR}/gestioncommandes.o gestioncommandes.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DVOCORE -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gestioncommandes_nomain.o gestioncommandes.c;\
	else  \
...
${OBJECTDIR}/gestionfichier_nomain.o: ${OBJECTDIR}/gestionfichier.o gestionfichier.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DVOCORE -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gestionfichier_nomain.o gestionfichier.c;\
	else  \
...
${OBJECTDIR}/gestiongpio_nomain.o: ${OBJECTDIR}/gestiongpio.o gestiongpio.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DVOCORE -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gestiongpio_nomain.o gestiongpio.c;\
	else  \
...
${OBJECTDIR}/gestionlog_nomain.o: ${OBJECTDIR}/gestionlog.o gestionlog.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DVOCORE -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gestionlog_nomain.o gestionlog.c;\
	else  \
...
${OBJECTDIR}/initialisation_nomain.o: ${OBJECTDIR}/initialisation.o initialisation.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DVOCORE -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/initialisation_nomain.o initialisation.c;\
	else  \
...
${OBJECTDIR}/main_nomain.o: ${OBJECTDIR}/main.o main.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DVOCORE -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_nomain.o main.c;\
	else  \
...
${OBJECTDIR}/serveurudp_nomain.o: ${OBJECTDIR}/serveurudp.o serveurudp.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DVOCORE -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/serveurudp_nomain.o serveurudp.c;\
	else  \
...
${OBJECTDIR}/tools_nomain.o: ${OBJECTDIR}/tools.o tools.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DVOCORE -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tools_nomain.o tools.c;\
	else  \
...
${OBJECTDIR}/voCoreGPIO_nomain.o: ${OBJECTDIR}/voCoreGPIO.o voCoreGPIO.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DVOCORE -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/voCoreGPIO_nomain.o voCoreGPIO.c;\
	else  \
