...
# C Compiler Flags
CFLAGS=-pthread -lwiringPi -lwiringPiDev -I/usr/local/include -L/usr/local/lib
...
${OBJECTDIR}/raspberryGPIO.o: raspberryGPIO.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -DRASPBERRY -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/raspberryGPIO.o raspberryGPIO.c
...
${OBJECTDIR}/raspberryGPIO_nomain.o: ${OBJECTDIR}/raspberryGPIO.o raspberryGPIO.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -DRASPBERRY -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/raspberryGPIO_nomain.o raspberryGPIO.c;\
	else  \
