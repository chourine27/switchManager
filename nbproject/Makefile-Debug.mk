...
${OBJECTDIR}/initialisation.o: initialisation.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/initialisation.o initialisation.c
...
${OBJECTDIR}/minuterie.o: minuterie.c nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/minuterie.o minuterie.c
...
${OBJECTDIR}/initialisation_nomain.o: ${OBJECTDIR}/initialisation.o initialisation.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/initialisation_nomain.o initialisation.c;\
	else  \
...
${OBJECTDIR}/minuterie_nomain.o: ${OBJECTDIR}/minuterie.o minuterie.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/minuterie_nomain.o minuterie.c;\
	else  \
